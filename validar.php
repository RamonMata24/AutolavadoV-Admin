<?php
    ...
    $usuario = filter_input(INPUT_POST,'nick');//se filtra el username
    $contrasena = filter_input(INPUT_POST, 'contrasena');//se filtra la password
	...
	$stmt = Conexion::conectar()->prepare('SELECT * FROM admin where nick = :nick');
